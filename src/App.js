...
class NetflixCloneApp extends React.Component {
  ...
  componentDidMount() {
    ...
    Movies.getByGenrer('Comedy').then(res => this.setState({ movies: { ...this.state.movies, comedyMovies: res } }));
    Movies.getByGenrer('Animation').then(res => this.setState({ movies: { ...this.state.movies, animationMovies: res } }));
    Movies.getByGenrer('Science Fiction').then(res => this.setState({ movies: { ...this.state.movies, scifiMovies: res } }));
    Movies.getByGenrer('Horror').then(res => this.setState({ movies: { ...this.state.movies, horrorMovies: res } }));
  }
