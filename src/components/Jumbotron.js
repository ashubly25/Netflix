  ...
  <div
    ...
    <div className="jumbotron-info-container">
      <div className="jumbotron-info">
        ...
        <span className="jumbotron-description">{movie.overview ? movie.overview : 'This movie does not have description.'}</span>
        ...
        <div className="jumbotron-buttons">
          <Button type="play" icon="play" onButtonPressed={() => console.log('To Watch')}>
            To Watch
          </Button>
          <Button
